...
public class UserMainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.user_activity_main, container, false);

        //((AppCompatActivity)getActivity()).setSupportActionBar(null);
        Toolbar toolbar = (Toolbar) getActivity().findViewById(R.id.toolbar);
        toolbar.setTitle("");
        toolbar.setTitleTextColor(0xffffffff);
        et = (EditText) getActivity().findViewById(R.id.searchTerm);
        ...
        artistListView = (ListView) v.findViewById(R.id.artist_list_view);
        ...
        trackFooter = new TextView(getContext());
        ...
        artistTextView = new TextView(getContext());
        ...
        artistFooter = new TextView(getContext());
        ...
        albumTextView = new TextView(getContext());
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (footerPos == position) {
                    Intent showAllSongResults = new Intent(getContext(), ShowAllSongResults.class);
        ...
        artistListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (footerPos == position) {
                    Intent showAllArtistResults = new Intent(getContext(), ShowAllArtistResults.class);
                    ...
                    Intent showArtistPage = new Intent(getContext(), ArtistPageActivity.class);
        ...
        albumListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (footerPos == position) {
                    Intent showAllArtistResults = new Intent(getContext(), ShowAllAlbumResults.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
     ...
     private class AlbumSelected implements Runnable {
        ...
        @Override
        public void run() {
            Intent showAlbumPage = new Intent(getContext(), AlbumPageActivity.class);
    ...
    public void onDestroyView() {
        super.onDestroyView();
        /*TODO: BETTER WAY TO CHANGE TOOLBAR*/
        Toolbar toolbar = (Toolbar) getActivity().findViewById(R.id.toolbar);
